...
#     hist=model.fit_generator(get_classify_batch(TRAIN_CLASSIFY_TRAIN_BATCH_SIZE, from_train=True), steps_per_epoch=TRAIN_CLASSIFY_STEPS_PER_EPOCH,
...
#                         callbacks=[tensorboard, checkpoint, early_stopping])
    ...
    np.savetxt(fname='test_loss.txt', X=test_loss)
    np.savetxt(fname='train_loss.txt', X=train_loss)
