# Global
DATASET_PATH = '../luna'
ANNOTATIONS_PATH = '../luna'
#ANNOTATIONS_PATH = '/input/Tianchi/dataset/csv'
PREPROCESS_PATH = '../luna/preprocess'
#PREPROCESS_PATH = '/input/Tianchi/preprocess2'
LOG_BASE_PATH = '../luna/output/training_logs'
...
TRAIN_SEG_TRAIN_BATCH_SIZE = 2
TRAIN_SEG_STEPS_PER_EPOCH = 45
TRAIN_SEG_VALID_BATCH_SIZE = 2
TRAIN_SEG_VALID_STEPS =45
TRAIN_SEG_EVALUATE_FREQ = 2

# Classification Model
TRAIN_CLASSIFY_MODEL = 'resnet'# VGG, DenseNet, Inception, ResNet
TRAIN_CLASSIFY_LEARNING_RATE = 1e-4
USE_SIMPLIFIED_VGG = True #VGG有简化版
